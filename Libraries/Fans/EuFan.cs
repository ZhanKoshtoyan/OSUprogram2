...
public class EuFan : IFan
{
    ...
    public string ProjectId =>
        $"ЕУ.{FanOperatingMaxTemperature}.{Size:000}.{CaseLength}.{ImpellerRotationDirection}.{NominalPower:0000}.{RoundedImpellerRotationSpeed:0000}.{CaseMaterial}.Y2";
    //=================================================================================================================

    public int ImpellerRotationSpeed =>
        (int)
        SimilarityCalculator.SimilarImpellerRotationSpeed(
            ((IFan) this).VolumeFlow(Data.ImpellerRotationSpeed),
